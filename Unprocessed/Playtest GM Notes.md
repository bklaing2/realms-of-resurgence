...
# Outline:
- start in small [[Settlement]]
- caravan arrives back from the [[The Wastes|Wastes]]
- caravan gets attacked by a group of Rotborne
	- a [[Rotborne Overseer]] standing back and killing the guards and the [[Mysts]] that are protecting the caravan
	- a handful [[Rotborne Feral]]s rampaging around the caravan and the travelers that were with it and destroying the goods
	- a couple of [[Rotborne Spawn]] fly ahead and through the gate of the [[Settlement]] when the [[Standing]] open it to go to the protection of the caravan, this is what the party will fight at level 0
	- party is called into action by the [[Standing]] and Bryceson's character to help close the gate before the rest of the Rotborne can enter inside
	- party helps close the gate, locking some of the [[Standing]], [[Mysts]], and caravan travelers outside to die. party can stand on the wall and watch it occur, or hear it from below
- Bryceson's character is part of the [[Standing]] or maybe [[Blood of the Wastes]] and gives some explanation for what those things were. then they are approached by a runner for the [[The Gathering Bright|Gathering Bright]] and called into their [[Reliquary]] and asked to help the settlement.
- the caravan was carrying something incredibly important for the [[Settlement]] (and [[The Gathering Bright]]) and its survival and now that much of the [[Standing]] is no longer living, they need a group of capable people to leave behind the protection of the [[Settlement]] and chase after the Rotborne and return with the artifact.
- level 1
