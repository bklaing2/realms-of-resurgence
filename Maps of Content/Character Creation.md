...
| :---------------------: | :-----------------: | :------------------------: | :----------------: | :--------------------------: |
| Athletics ([[Fighter]]) |    ***Finesse***    |   Acrobatics ([[Scout]])   |                    |     Animism ([[Druid]])      |
| Athletics ([[Brawler]]) | Stealth ([[Scout]]) |      ***Intuition***       |                    | Summoning ([[Spiritwalker]]) |
|        Survival         |                     |  Tinkering ([[Engineer]])  | ***Intelligence*** |   Inscription ([[Scribe]])   |
| Constitution ([[Mage]]) |     ([[Druid]])     |     ([[Spiritwalker]])     |    ([[Scribe]])    |         ***Mantic***         |
