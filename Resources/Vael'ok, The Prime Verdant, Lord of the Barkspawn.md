...
**Actions**:  
**Multiattack**: (4) Vael'ok makes 4 attacks (3 longsword attacks and 1 bark shield bash) each turn.
# Attacks:
## Longsword:
+9 to hit  
5 ft range  
...
## Bark Spawn:
*Refreshes on a 5-6*
As an action, Vael'ok summon another Barkspawn creature to aid them in this battle, pulled from the Barkspawn that Vael'ok has killed and joined to their root system over the centuries. The summoned Barkspawn come out of the vines and roots nearby with their heads removed and a dark void able to be seen inside.
**Roll a d4:**
...
When a PC within 25 ft rolls a radiation failure, the bark and roots around Vael'ok rise up 15 ft and allow Vael'ok to "fly" for 1d6 rounds. Anywhere that Vael'ok walks, roots and bark rise up to allow Vael'ok to walk there. At the end of the rounds, they lower Vael'ok back to the ground. On Vael'ok's turn, Vael'ok can move normal movement, but now can go up and down as well.
